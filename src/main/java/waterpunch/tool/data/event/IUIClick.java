...
// event.getInventory().getType() != InventoryType.CHEST) return;
// // IUIClickEvent iui = new IUIClickEvent((Player) event.getWhoClicked(),
// IUIHolder.get(event.getInventory()), event.getRawSlot());
