...
/**
 * @author maguro027
 * @version 0.1 このクラスは、クライアント用パケットの基底クラスです。
 */
public class ClientPacket extends IUIPacket {
    ...
    public enum ClientPacketType {
        PING, IUISERVERRESPONSE, IUIServerFastConnect, IUIUPLoadRequest, IUIDeleteRequest, IUIListGetRequest, IUIGetRequest, IUIItemUPLoadRequest,
    }
    ...
    private String send(byte[] bytes) {
        try (Socket socket = new Socket(Core.getHost(), Core.getPort());
